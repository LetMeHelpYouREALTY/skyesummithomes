...
const { cdnUrl } = require('./image-cdn');
...
const HERO_BY_FILE = {
  ...
  'buy.html': {
    src: `${HERO_DIR}/hero-buy-skye-summit.jpg`,
  ...
  'community.html': {
    src: `${HERO_DIR}/hero-community-lifestyle.jpg`,
  ...
  'contact.html': {
    src: `${HERO_DIR}/hero-contact-consult.jpg`,
  ...
  'about.html': {
    src: `${HERO_DIR}/hero-about-advisor.jpg`,
    alt: 'Professional consultation office for Dr. Jan Duffy, Skye Summit REALTOR at Berkshire Hathaway HomeServices Nevada Properties',
    caption: 'Dr. Jan Duffy — Skye Summit REALTOR®',
    name: 'About Dr. Jan Duffy',
    description:
      'Office consultation setting for Dr. Jan Duffy, REALTOR® (S.0197614.LLC), Skye Summit Homes buyer’s representative.',
    width: '1280',
    height: '720',
  },
  'office-location.html': {
    ...
    description:
      'Southern Highlands office exterior matching the Google Maps pin for Berkshire Hathaway HomeServices Nevada Properties, Las Vegas 89141.',
    width: '1280',
    height: '720',
  },
  ...
  'new-construction-skye-summit.html': {
    src: `${HERO_DIR}/hero-new-construction.jpg`,
  ...
  'skye-summit-interest-list.html': {
    ...
    description:
      'Graded desert homesites and Red Rock backdrop for early-interest list signups for Skye Summit builder releases.',
    width: '1280',
    height: '720',
  },
  ...
  'olympia-companies-skye-summit.html': {
    src: `${HERO_DIR}/hero-olympia-community.jpg`,
  ...
  'woodside-homes-skye-summit.html': {
    src: `${HERO_DIR}/hero-woodside-homes.jpg`,
  ...
  'skye-summit-timeline.html': {
    ...
    alt: 'Skye Summit Master Plan Fall 2027 timeline earthwork and desert mountains northwest Las Vegas',
    caption: 'Skye Summit timeline — Fall 2027',
    name: 'Skye Summit Timeline',
    description: 'Construction-phase desert landscape for Skye Summit launch timeline and builder milestones.',
    width: '1280',
    height: '720',
  },
  'skye-summit-realtor.html': {
    src: `${HERO_DIR}/hero-realtor-consult.jpg`,
    alt: 'Dr. Jan Duffy, Skye Summit realtor, consulting at Berkshire Hathaway HomeServices Nevada Properties',
    caption: 'Your Skye Summit REALTOR®',
    name: 'Skye Summit REALTOR',
    description:
      'Office consultation setting for Dr. Jan Duffy Skye Summit buyer representation pages.',
    width: '1280',
    height: '720',
  },
  ...
  'living-in-skye-summit.html': {
    ...
    alt: 'Living near Red Rock Canyon in Skye Summit Master Plan northwest Las Vegas lifestyle trails',
    caption: 'Living in Skye Summit',
    name: 'Living in Skye Summit',
    description: 'Desert trail and pocket park for Skye Summit lifestyle and living guide.',
    width: '1280',
    height: '720',
  },
  'skye-summit-hoa.html': {
    ...
    description: 'Community park amenities for Skye Summit HOA overview.',
    width: '1280',
    height: '720',
  },
  ...
  'northwest-las-vegas-real-estate.html': {
    ...
    alt: 'Northwest Las Vegas real estate streetscape near Centennial Hills and Skye Summit',
    caption: 'Northwest Las Vegas real estate',
    name: 'Northwest Las Vegas Real Estate',
    description: 'Neighborhood streetscape for northwest Las Vegas market pages.',
    width: '1280',
    height: '720',
  },
  'centennial-hills-real-estate.html': {
    ...
    description: 'Centennial Hills streetscape for Skye Summit adjacency pages.',
    width: '1280',
    height: '720',
  },
  'blog.html': {
    src: `${HERO_DIR}/hero-blog-market.jpg`,
    alt: 'Skye Summit Las Vegas real estate blog market research on a desk',
    caption: 'Skye Summit Homes blog',
    name: 'Skye Summit Blog',
    description: 'Market-research desk hero for Skye Summit community articles.',
    width: '1280',
    height: '720',
  },
  'privacy.html': {
...
function heroForFile(relPath) {
  ...
  // nested /slug/index.html → slug.html (must run before bare index.html match)
...
function absoluteUrl(src) {
  ...
  const delivered = cdnUrl(src, { width: 1600 });
  if (/^https?:\/\//i.test(delivered)) return delivered;
  return `${C.SITE}${src.startsWith('/') ? src : `/${src}`}`;
}
