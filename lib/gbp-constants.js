...
module.exports = {
  ...
  /** Default social/OG image — homepage hero (must exist in repo; ≥1200px for Discover) */
  OG_IMAGE_PATH: '/images/hero/sunset-home.jpg',
  ...
  /** Visible hours — matches GBP main hours (Sun–Sat 8 AM–8 PM) */
  HOURS: [{ days: 'Sunday – Saturday', time: '8:00 AM – 8:00 PM' }],
  HOLIDAY_NOTES: [
  ...
  LABEL_VIEW_ON_GOOGLE: 'View Google Reviews',
