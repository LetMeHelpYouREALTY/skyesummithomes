...
module.exports = {
  ...
  PLUS_CODE: '7MG5+RWM',
  ADDRESS_LOCALITY: 'Las Vegas, Nevada',
  /** Visible NAP — matches GBP */
  ADDRESS_DISPLAY: '7MG5+RWM Las Vegas, Nevada',
  ADDRESS_HTML: '7MG5+RWM<br>Las Vegas, Nevada',
  STREET: '7MG5+RWM',
  CITY: 'Las Vegas',
  REGION: 'NV',
  POSTAL: '89166',
  ...
  HOMEPAGE_OFFICE_LINE:
    "Office at 7MG5+RWM Las Vegas, Nevada—buyer's representative for the Skye Summit Master Plan (coming Fall 2027).",
  /** Site hyperlocal copy — scoped to Skye Summit Master Plan only */
  HYPERLOCAL_LEAD:
    'Dr. Jan Duffy, licensed Nevada Realtor since 2009, is your buyer\'s representative for the Skye Summit Master Plan—a 505-acre Olympia Companies community coming Fall 2027. Early-access updates, builder coordination, and new-construction buyer representation from our Skye Summit area office (7MG5+RWM Las Vegas, Nevada).',
  ...
  MAPS_DIRECTIONS:
    'https://maps.google.com/?q=7MG5%2BRWM+Las+Vegas,+Nevada',
  MAP_EMBED:
    'https://www.google.com/maps?q=7MG5%2BRWM+Las+Vegas,+Nevada&output=embed',
  /** WGS84 — matches GBP pin (7MG5+RWM Las Vegas, Nevada) */
  GEO_LAT: 36.277088,
  GEO_LNG: -115.340203,
  GEO_POSITION: '36.277088;-115.340203',
  GEO_ICBM: '36.277088, -115.340203',
  MAP_PAGE_PATH: '/office-location',
  OSM_MAP_URL:
    'https://www.openstreetmap.org/?mlat=36.277088&mlon=-115.340203#map=17/36.277088/-115.340203',
