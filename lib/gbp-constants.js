...
module.exports = {
  ...
  MASTER_PLAN_BUILDER_NOTE:
    'KB Home Vertice (299 homesites, sales may open early 2027), Woodside Homes, and Century Communities are among builders acquiring land in the master plan.',
  ...
  GEO_CONTEXT_ENTITIES: [
    ...
    'Century Communities Skye Summit',
    '215 Beltway corridor',
    'Red Rock Canyon corridor',
  ],
  SCHEMA_KNOWS_ABOUT: [
    'Skye Summit Master Plan',
