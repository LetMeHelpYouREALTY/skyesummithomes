...
const { cdnUrl, originUrl } = require('./image-cdn');
...
function photoUrl(gitPath) {
  const delivered = cdnUrl(gitPath);
  if (/^https?:\/\//i.test(delivered)) return delivered;
  return originUrl(gitPath);
}
...
function buildOrganization() {
  return {
    ...
    name: C.BROKERAGE,
    url: C.SITE,
    logo: photoUrl('/images/agents/dr-jan-duffy.jpg'),
    sameAs: C.SAME_AS,
  };
}
...
function buildPerson() {
  return {
    ...
    email: C.EMAIL,
    url: C.SITE,
    image: photoUrl('/images/agents/dr-jan-duffy.jpg'),
...
function buildLocalBusiness() {
  return {
    ...
    url: C.SITE,
    image: [
      photoUrl('/images/agents/dr-jan-duffy.jpg'),
      photoUrl(C.OG_IMAGE_PATH),
      photoUrl('/images/hero/hero-office-southern-highlands.jpg'),
    ],
    photo: [
      {
        '@type': 'ImageObject',
        contentUrl: photoUrl('/images/agents/dr-jan-duffy.jpg'),
        name: `${C.AGENT_NAME} headshot`,
        caption: `${C.AGENT_NAME}, ${C.AGENT_TITLE}`,
      },
      {
        '@type': 'ImageObject',
        contentUrl: photoUrl(C.OG_IMAGE_PATH),
        name: 'Skye Summit Homes Las Vegas',
        caption: 'Skye Summit Master Plan — desert contemporary homes near Red Rock Canyon',
      },
      {
        '@type': 'ImageObject',
        contentUrl: photoUrl('/images/hero/hero-office-southern-highlands.jpg'),
